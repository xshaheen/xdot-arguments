...
public static partial class ItShouldExtensions {
    ...
    public static T BeInEnum<T>(this It _, T argument, string? message = null, [CallerArgumentExpression("argument")] string? paramName = null) where T : struct, Enum {
...
#pragma warning restore MA0015
    ...
    /// <inheritdoc cref="BeInEnum{T}(It,T,string?,string?)"/>
    public static int BeInEnum<T>(this It _, int argument, string? message = null, [CallerArgumentExpression("argument")] string? paramName = null) where T : struct, Enum {
        if (Enum.IsDefined(typeof(T), argument)) {
            return argument;
        }
